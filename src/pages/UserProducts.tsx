  ...
  async function getUserProducts(): Promise<Product[]> {
    try {
      ...
      const userProducts = result.filter(
        (product: any) => product.ownerId === user?.id
      );
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-[#8b5cf6] hover:bg-[#7c3aed] text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 cursor-pointer"
              >
                Add New Product
              </button>
            </div>
          ...
          <div className="bg-[#121212] border border-[#27272a] rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                <button
                  type="submit"
                  className="flex-1 bg-[#8b5cf6] hover:bg-[#7c3aed] text-white py-2 rounded-lg font-medium transition-all duration-300 cursor-pointer"
                >
                  Add Product
                </button>
                <button
                  ...
                  className="flex-1 bg-gray-600 hover:bg-gray-700 text-white py-2 rounded-lg font-medium transition-all duration-300 cursor-pointer"
                >
                  Cancel
                </button>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <button
              onClick={() => setShowAddForm(true)}
              className="bg-[#8b5cf6] hover:bg-[#7c3aed] text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 cursor-pointer"
            >
                ...
                <div className="p-4">
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="flex-1 bg-[#8b5cf6] hover:bg-[#7c3aed] text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 cursor-pointer"
                    >
                      Edit
                    </button>
                    <button
                      onClick={() => handleDelete(product.id)}
                      className="flex-1 bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 cursor-pointer"
                    >
                      Delete
                    </button>
                  </div>
