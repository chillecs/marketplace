      ...
      <div className="bg-[#121212] border-b border-[#27272a] px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link to={`/?category=${product.category}`} className="text-gray-400 hover:text-[#8b5cf6] transition-colors">
              {product.category}
            </Link>
            <span className="text-gray-600">/</span>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-gray-600">•</span>
                <span className="text-gray-400">by {product.seller}</span>
              </div>
            </div>
            ...
            <div className="bg-[#121212] border border-[#27272a] rounded-lg p-6">
              ...
              <p className="text-gray-400 text-sm mt-2">Free shipping • 30-day returns</p>
            </div>
